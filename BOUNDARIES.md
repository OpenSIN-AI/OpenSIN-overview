...
- `team.json` _content_ of any individual team (each team repo owns its own manifest; this repo only mirrors them under `templates/teams/` as a read-through SSOT for the aggregator)
