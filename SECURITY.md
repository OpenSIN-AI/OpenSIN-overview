...
## 5. What counts as a vulnerability in *this* repo
...
- **Schema escape** — any `schemas/*.schema.json` that allows values that downstream consumers (marketplace UI, chat.opensin.ai dashboard) interpret as HTML/JS/SQL without further validation. Schemas here are the *first* line of defence for the marketplace.
