...
>
> 📊 **205 Repositories** (177 live, 28 archived) | **17 Teams** | **149 Worker** | **4 Templates** | **44 Skills** | **7 Websites**
>
> 🔄 Live counts auto-generated by `scripts/generate-master-index.js`. See [registry/MASTER_INDEX.md](./registry/MASTER_INDEX.md) for the full list.
...
## CI/CD — n8n OCI Runner (not GitHub-hosted)

All CI runs on a self-hosted n8n + OCI VM pipeline. GitHub-hosted runners are **explicitly disallowed** org-wide (billing failures + zero-cost OCI alternative).

- **Webhook DNS (public):** `https://n8n.delqhi.com/webhook/opensin-ci`
- **GitHub Action:** [`OpenSIN-AI/sin-github-action`](https://github.com/OpenSIN-AI/sin-github-action) (composite, ~2s curl-only)
- **Internal infra (IP, API keys, systemd unit names):** documented in `Infra-SIN-Dev-Setup` (private) — see ops-runbook. **Never commit internal IPs, hostnames, or API keys to this repo.**
- **Full setup for a new repo:** [`docs/best-practices/ci-cd-n8n.md`](./docs/best-practices/ci-cd-n8n.md) (public-safe redacted version) or [docs.opensin.ai/best-practices/ci-cd-n8n](https://docs.opensin.ai/best-practices/ci-cd-n8n).

Scope note: this repo indexes the CI contract. The operational runbook, credentials, and infrastructure addresses live in `Infra-SIN-Dev-Setup`. See [BOUNDARIES.md § Rule 5](./BOUNDARIES.md).
...
| _(internal API)_                                       | [OpenSIN-backend](https://github.com/OpenSIN-AI/OpenSIN-backend)                   | A2A Fleet Control Plane (Closed Source) — Backend-API, n8n-Routing, Agenten-Orchestrierung — konsumiert von `OpenSIN-WebApp` | 🔒 Privat    |
...
| Repo                                                                                         | Zweck                                                                                                                                                                                                                               |
| -------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [OpenSIN-overview](https://github.com/OpenSIN-AI/OpenSIN-overview)                           | **SSOT**: START-HERE.md, LAUNCH-CHECKLIST.md, CANONICAL-REPOS.md, MASTER_INDEX.md (auto-generated, 205 repos)                                                                                                                       |
| [OpenSIN-documentation](https://github.com/OpenSIN-AI/OpenSIN-documentation)                 | Verbraucher-Doku (VitePress) — docs.opensin.ai                                                                                                                                                                                      |
| [website-developers.opensin.ai](https://github.com/OpenSIN-AI/website-developers.opensin.ai) | Entwickler-Portal — developers.opensin.ai/docs                                                                                                                                                                                      |
...
1. **Lies die Regeln:** → [AGENTS.md](./AGENTS.md) und [START-HERE.md](./START-HERE.md)
...
_Zuletzt aktualisiert: 2026-04-09 | OpenSIN-AI CEO Audit_
