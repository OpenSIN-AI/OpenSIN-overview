...
| `Team-SIN-*` repos                  |                17 | **0** (teams live as manifest files in _this_ repo only) |                         −17 |
| `Biz-SIN-*`                         |                 7 |                                                    **4** |                          −3 |
| `Infra-SIN-*`                       |                 6 |                                                    **4** |                          −2 |
| `MCP-SIN-*`                         |                 7 |                                                    **0** |                          −7 |
...
7 `A2A-SIN-*` repos exist but are not registered in any team manifest _and_ are not mentioned in the doc prose:
...
3. **Stop editing canon-locked docs until A/B/C is picked.** Any edit that silently fixes a number without CTO sign-off is _more_ drift.
